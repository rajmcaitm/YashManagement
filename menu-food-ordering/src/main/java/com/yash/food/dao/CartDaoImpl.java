...
import com.yash.food.model.NewFood;
...
//            foodDao.save(new Food(newFood.getId(),newFood.getName(),newFood.getPrice(),newFood.getQuantityAvailable(),"\\"+file.getOriginalFilename(),"",""));
    ...
    public boolean addNewItemWithUrl(String newFoodData) throws IOException {
        ...
        Food food = new Food(newFood.getId(),newFood.getName(),newFood.getPrice(),newFood.getQuantityAvailable(),newFood.getFileDataF(),"","");
        System.out.println(food.getUrl()+" "+food.getId()+" "+food.getItem());
        return true;
    }
